                                ...
                                <div className="profile-form-item">
                                    <div className="row profile-block">
                                        <div className="col profile-block-left">
                                                    ...
                                                    <input  readOnly={this.ProfileOvner()} type="text" className="form-control" placeholder={this.props.singlPr.profile.githubusername}  />
                                        </div>
                                        <div className="col profile-block-right">
                                                    <label htmlFor="name">Name</label>
                                                    <input  readOnly={this.ProfileOvner()} type="text" className="form-control" placeholder={this.props.singlPr.name} />
                                        </div>
                                    </div>
                                </div>
                                <div className="profile-form-item">
                                        <div className="row profile-block">
                                            <div className="col profile-block-left">
                                                ...
                                                <input  readOnly={this.ProfileOvner()} type="phone" className="form-control" placeholder={this.props.singlPr.profile.social.phone_number} />
                                            </div>
                                            <div className="col profile-block-right">
                                                <label htmlFor="name">City</label>
                                                <input  readOnly={this.ProfileOvner()} type="text" className="form-control" placeholder={this.props.singlPr.profile.location} />
                                            </div>
                                        </div>
                                </div>
                                <div className="profile-form-item social-form">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col">
                                            ...
                                            <input  readOnly={this.ProfileOvner()} type="text" className="form-control" placeholder={this.props.singlPr.profile.social.linkedin} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="row sub-ptofile-form">
                                        <div className="col">
                                            ...
                                            <input  readOnly={this.ProfileOvner()} type="text" className="form-control" placeholder={this.props.singlPr.profile.social.facebook}/>
                                        </div>
                                        <div className="col">
                                            <label htmlFor="field">Instagram</label>
                                            <input  readOnly={this.ProfileOvner()} type="text" className="form-control" placeholder={this.props.singlPr.profile.social.instagram} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="row sub-ptofile-form">
                                        <div className="col">
                                            ...
                                            <input  readOnly={this.ProfileOvner()} type="text" className="form-control" placeholder={this.props.singlPr.profile.social.twitter} />
                                        </div>
                                        <div className="col">
                                            <label htmlFor="field">Youtube</label>
                                            <input  readOnly={this.ProfileOvner()} type="text" className="form-control" placeholder={this.props.singlPr.profile.social.youtube} />
                                        </div>
                                    </div>
                                </div>
                                 <div className="profile-form-item social-form">
